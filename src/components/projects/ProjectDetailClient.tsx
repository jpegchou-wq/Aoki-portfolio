    ...
    <div className="pt-24 md:pt-32 pb-16 md:pb-24">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="mb-8 sm:mb-10">
          <Link
            href="/projects"
            className="inline-flex items-center px-4 sm:px-5 py-2 rounded-full bg-black/5 text-black/60 hover:text-black hover:bg-black/10 transition-colors"
          >
        ...
        >
          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="space-y-3 sm:space-y-4">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold tracking-tight text-black/90">
                {content.title}
              </h1>
              <p className="text-black/45 text-base sm:text-lg font-light leading-relaxed">
                {content.description}
              </p>
            </div>
        ...
        {detail?.role && (
          <section className="glass-card rounded-[2rem] p-6 sm:p-10 mt-10 sm:mt-12">
